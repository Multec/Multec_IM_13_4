...
public class scene1 extends AbstractScene {
		...
		public scene1(final MTApplication mtApplication, String name) {
			...
			//Textfield
			final MTTextField textField1 = new MTTextField(0,200,500,500,font, mtApplication); 
			textField1.setFillColor(textAreaColor);
			textField1.setStrokeColor(textAreaColor);
			this.clearAllGestures(textField1);
			textField1.setText("DIT IS DE EERSTE PAGINA");
			textField1.setAnchor(PositionAnchor.UPPER_LEFT);
			this.getCanvas().addChild(textField1);
			
			PImage loadedImage = app.loadImage("program1.png");
			...
			PImage loadedImage3 = app.loadImage("webdev1.png");
			MTRectangle loadedRectangle3 = new MTRectangle(loadedImage3, app);
			getCanvas().addChild(loadedRectangle3);
			loadedRectangle3.setPositionGlobal(new Vector3D(1500,300,0));
			loadedRectangle3.setNoStroke(true);
